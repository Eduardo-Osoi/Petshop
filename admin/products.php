...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('¿Está seguro de que desea eliminar este producto?');">Borrar</a>
      </div>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">No hay productos en el inventario</p>';
      }
   ?>
