...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">PetShop<span>.</span></a>
      ...
      <div class="profile">
         ...
         <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('¿Está seguro de que desea salir?');">Cerrar sesión</a> 
         <?php
            }else{
         ?>
         <div class="flex-btn">
