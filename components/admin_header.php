...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="../admin/dashboard.php" class="logo">Panel<span>Administrativo</span></a>
      ...
      <div class="profile">
         ...
         <a href="../components/admin_logout.php" class="delete-btn" onclick="return confirm('¿Está seguro de que desea salir?');">Cerrar sesión</a> 
      </div>
