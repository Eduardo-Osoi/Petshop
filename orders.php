...
<section class="orders">
   ...
   <?php
      if($user_id == ''){
         echo '<p class="empty">Inicia sesión para visualizar tus pedidos</p>';
      }else{
   ...
   <div class="box">
      ...
      <p>Estado del pedido: <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
         echo '<p class="empty">No tienes pedidos realizados</p>';
      }
      }
   ?>
